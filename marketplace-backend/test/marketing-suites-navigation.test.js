...
test('Sales Marketing Suite navigation and workspace isolation', (t) => {
  ...
  assert.deepEqual({ page: automations.page, tab: automations.tab, studio: automations.studio }, { page: 'automation-builder', tab: 'automations', studio: 'automation' });
...
test('Complete Marketing Suite navigation uses one shared cross-department Pulse', (t) => {
  const sandbox = createFrontendSandbox({
