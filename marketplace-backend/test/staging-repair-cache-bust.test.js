...
test('every frontend asset edited by the staging repair has the release cache version', () => {
  ...
  assert.ok(html.includes('css/marketsync-theme.css?v=20260905_mobile_chrome_obs_v1'), 'marketsync-theme.css mobile studio cache version is stale')
  ...
  assert.equal((loader.match(/js\/modules\/studio\/studio-shell\.js\?v=20260905_mobile_chrome_obs_v1/g) || []).length, 2)
})
