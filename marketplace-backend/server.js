...
// RETURN THE DEALER DATA SO THE FRONTEND CAN USE IT
res.status(201).json({ 
  message: 'Dealership provisioned successfully', 
  dealer: dealer // <--- ADD THIS
});
...
app.get('/dealership/team-insights', requireAuth, async (req, res) => {
  ...
  // If status is not 'ACTIVE', block access to revenue-generating tools
