...
SELECT r.role_id, r.permission_id FROM (VALUES
 ...
 ('bdc','customer.view'),('bdc','lead.create'),('fni_manager','customer.view'),('fni_manager','deal.create'),('fni_manager','deal.approve'),('fni_manager','deal.finalize'),('fni_manager','credit_application.view'),('fni_manager','credit_application.manage'),
