...
export const COURSES = [
  ...
  c('prod_design_studio', 'Design Studio ($19.99/mo)', 'Products', 'foundation', 15,
    'Creating dealership graphics, logo asset vaults, and branded social assets — plus AI generation and the multi-channel social scheduler, calendar scheduling, team publishing queues, and post analytics, all included at one flat price.', 120),
