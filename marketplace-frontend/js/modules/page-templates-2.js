...
(function injectPageTemplates() {
  try {
    ...
    if (host) {
      host.insertAdjacentHTML('beforeend', `<!-- Deep reports (sales, F&I, leads, reps, appraisals, service, activity, customers) -->
...
<div data-page-content="inventory" class="page-content hidden hidden space-y-8">
...
<div data-page-content="leaderboard" class="page-content hidden hidden space-y-6">
