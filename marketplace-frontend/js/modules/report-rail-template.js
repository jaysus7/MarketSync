// ── MarketSync Report Rail Template Module ─────────────────────────────────
(function injectReportRail() {
  try {
    if (!document.getElementById('report-rail')) {
  ...
  <!-- ── 2. Department Setup Wizard Modal ── -->
  ...
  <script src="table-sort.js?v=20260706a"></script>
      ...
      var rr = document.getElementById('report-rail');
      if (rr) rr.classList.remove('hidden');
    }
  } catch (e) { console.error('[Report Rail Init]', e); }
})();
