...
const ACAD_DEPARTMENTS = [
  ...
  { key: 'management', name: 'Management & Leadership', icon: 'building', color: 'indigo', bg: 'bg-indigo-50 dark:bg-indigo-950/40 border-indigo-200 dark:border-indigo-800 text-indigo-800 dark:text-indigo-300', description: 'Pulse dealership operational intelligence, staff onboarding, approval matrix & store analytics' },
