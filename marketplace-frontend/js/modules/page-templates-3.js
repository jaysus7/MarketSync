// ── MarketSync Page Template Submodule (Part 3) ─────────────────────────────
(function injectPageTemplates() {
  try {
    ...
    if (host) {
      host.insertAdjacentHTML('beforeend', `<!-- ── Legend (compact, always visible at top) ── -->
...
<div data-page-content="sales-team" class="page-content hidden hidden space-y-8">
...
<div data-page-content="inv-intel" class="page-content hidden hidden space-y-6">
...
<!-- Summary stat cards — click to filter the list below -->
  ...
  } catch (e) { console.error('[Page Templates Init: Part 3]', e); }
})();
