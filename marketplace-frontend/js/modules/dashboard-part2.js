...
function msLoadDesignStudioShell() {
  ...
  window.__msDesignStudioShellPromise = Promise.resolve(window.msLoadScript('js/modules/studio/scene-model.js?v=20260814_v12'))
    ...
    .then(() => window.msLoadScript('js/modules/studio/fabric-adapter.js?v=20260906_studio_diag_v3'))
    .then(() => window.msLoadScript('js/modules/studio/studio-shell.js?v=20260906_studio_diag_v3'))
