...
function switchPage(pageId) {
  ...
  if (pageId === 'studio' || pageId === 'design-studio') {
    Promise.resolve(window.msLoadScript ? window.msLoadScript('js/modules/studio/scene-model.js?v=20260814_v12') : null)
      ...
      .then(() => window.msLoadScript && window.msLoadScript('js/modules/studio/fabric-adapter.js?v=20260906_ws_overflow_v1'))
      .then(() => window.msLoadScript && window.msLoadScript('js/modules/studio/studio-shell.js?v=20260906_ws_overflow_v1'))
...
window.ensureOpenMarketSyncStudio = function ensureOpenMarketSyncStudio(designId, opts) {
  ...
  const load = window.msLoadScript
    ? Promise.resolve(window.msLoadScript('js/modules/studio/scene-model.js?v=20260814_v12'))
        ...
        .then(() => window.msLoadScript('js/modules/studio/fabric-adapter.js?v=20260906_ws_overflow_v1'))
        .then(() => window.msLoadScript('js/modules/studio/studio-shell.js?v=20260906_ws_overflow_v1'))
    : Promise.resolve();
