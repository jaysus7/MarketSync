...
const STUDIO_BRAND_ICON_LIBRARY = Array.from(new Set(['facebook','instagram','linkedin','tiktok','youtube','x-twitter','whatsapp','telegram','discord','reddit','pinterest','snapchat','threads','twitch','spotify','apple','google','microsoft','amazon','github','gitlab','slack','figma','canva','wordpress','shopify','wix','squarespace','stripe','paypal','square','uber','lyft','airbnb','skype','vimeo','dribbble','behance','medium','tumblr','yelp','tripadvisor','wikipedia-w','stack-overflow','codepen','npm','node','react','vuejs','angular','svelte','html5','css3-alt','js','python','java','php','swift','android','chrome','firefox','safari','edge','opera','internet-explorer','linux','windows','docker','aws','cloudflare','mailchimp','hubspot','salesforce','intercom','hubspot','google-drive','dropbox','onedrive','box','evernote','jira','trello','asana','notion','meetup','sketch','adobe','autoprefixer','bootstrap','tailwind-css','sass','less','npm','git-alt','bitbucket','firstdraft','monday','readme','weixin','line','viber','signal-messenger','kickstarter','patreon','buy-n-large','product-hunt','steam','xbox','playstation','app-store','google-play','goodreads','lastfm','soundcloud','deezer','bandcamp','itunes','reddit-alien','facebook-messenger','google-business','google-pay','apple-pay','cc-visa','cc-mastercard','cc-amex','cc-paypal','cc-stripe','wifi','phone','envelope','globe']).map((name, index) => ({ id: `brand-icon-${index + 1}`, name, label: name.replace(/-/g, ' ') })));
