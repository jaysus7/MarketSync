...
(function () {
  ...
  function headerHTML() {
    ...
    return '' +
      ...
      '<div class="ms-mobile" hidden>' +
        ...
        '<a href="/compare.html" class="ms-m-link ms-m-top">Pricing</a>' +
  ...
  function footerHTML() {
    ...
    return '' +
      ...
      '<div class="ms-f-grid">' +
        ...
        col('Get started', [['Start free trial', TRIAL], ['Log in', '/login.html']]) +
      '</div>' +
  ...
  var CSS = '' +
    ...
    '.ms-hd-in{max-width:1120px;margin:0 auto;height:56px;display:flex;align-items:center;gap:24px;padding:0 22px;}' +
    ...
    '.ms-f-grid{max-width:1120px;margin:0 auto;padding:52px 22px;display:grid;grid-template-columns:1.4fr repeat(4,1fr);gap:32px;border-top:1px solid rgba(255,255,255,.08);}' +
    ...
    '.ms-f-bottom{max-width:1120px;margin:0 auto;padding:22px;font-size:13px;border-top:1px solid rgba(255,255,255,.08);}' +
    /* motion */
