...
(function () {
  ...
  function footerHTML() {
    ...
    return '' +
      ...
      '</div>' +
      '<div class="ms-f-grid">' +
        '<div class="ms-f-brand"><a href="/" class="ms-logo ms-logo-sm"><img src="/Logo 2.1.png" alt="MarketSync DealerOS" style="height:36px; width:auto;"></a><p>The intelligent automotive operating system &amp; digital growth platform.</p></div>' +
        cols +
      '</div>' +
