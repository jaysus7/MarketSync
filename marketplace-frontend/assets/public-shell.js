...
(function () {
  ...
  function headerHTML() {
    ...
    return '' +
      '<a href="/" class="ms-logo" aria-label="MarketSync home"><img src="/Logo 2.0.png" alt="MarketSync DealerOS" class="ms-logo-light" style="height:54px; width:auto;"><img src="/Logo 2.1.png" alt="MarketSync DealerOS" class="ms-logo-dark" style="height:54px; width:auto;"></a>' +
  ...
  function footerHTML() {
    ...
    return '' +
      ...
      '</div>' +
      '<div class="ms-f-grid">' +
        '<div class="ms-f-brand"><a href="/" class="ms-logo ms-logo-sm"><img src="/Logo 2.0.png" alt="MarketSync DealerOS" class="ms-logo-light" style="height:44px; width:auto;"><img src="/Logo 2.1.png" alt="MarketSync DealerOS" class="ms-logo-dark" style="height:44px; width:auto;"></a><p>The intelligent automotive operating system &amp; digital growth platform.</p></div>' +
        cols +
      '</div>' +
