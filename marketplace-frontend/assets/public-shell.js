...
(function () {
  ...
  function headerHTML() {
    ...
    return '' +
      '<a href="/" class="ms-logo" aria-label="MarketSync home"><img src="/assets/brand/marketsync-logo-primary.png" alt="MarketSync DealerOS" class="ms-logo-light" style="height:44px; width:auto;"><img src="/assets/brand/marketsync-logo-white.png" alt="MarketSync DealerOS" class="ms-logo-dark" style="height:44px; width:auto;"></a>' +
  ...
  function footerHTML() {
    ...
    return '' +
      ...
      '</div>' +
      '<div class="ms-f-grid">' +
        '<div class="ms-f-brand"><a href="/" class="ms-logo ms-logo-sm"><img src="/assets/brand/marketsync-logo-white.png" alt="MarketSync DealerOS" style="height:36px; width:auto;"></a><p>The intelligent automotive operating system &amp; digital growth platform.</p></div>' +
        cols +
      '</div>' +
