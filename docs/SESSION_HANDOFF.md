...
| **Baseline on `staging`** | `e81e5d8` — Phase 8 coherence, normalized My Day, Management composition, provider-first Identity, credit/affordability/vehicle fit, the dealer Social Scheduler, Studio editor, actionable identity review, restored Inventory Intelligence navigation, no-emoji cleanup, operational Social calendar, sold-vehicle protection, My Day runtime repair, and per-network social captions are merged. CI is green. The current vehicle-fit action slice has focused coverage green. |
