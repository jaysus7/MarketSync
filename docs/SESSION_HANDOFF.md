...
| **Baseline on `staging`** | `fb255c4` — Phase 8 coherence, normalized My Day, Management composition, provider-first Identity, credit/affordability/vehicle fit, the dealer Social Scheduler and Studio editor are merged; CI is green. The merged suite is **1086/1086** with all six `check:*`. |
